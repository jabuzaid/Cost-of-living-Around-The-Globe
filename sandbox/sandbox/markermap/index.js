...
// **************************************************************
//
// Define variables for our streetmap base layer
...
// Define variables for our darkmap base layer
...
d3.csv("cost_of_living_data_combine.csv").then(data => {
    ...
    data2016.forEach(d => {
        ...
        .bindPopup("<h3>" + d.City + ", " + d.Country + "</h3>" + "<h5>" + "Rent Index: " + d.RentIndex + "</h5>" + "<h5>" + "Local Purchasing Power Index: " + d.LocalPurchasingPowerIndex + "</h5>"));
    });
